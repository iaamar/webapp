...
aws configure set aws_access_key_id ${process.env.AWS_ACCESS_KEY_ID} --profile dev
aws configure set aws_secret_access_key ${process.env.AWS_SECRET_ACCESS_KEY} --profile dev
aws configure set region ${process.env.AWS_DEFAULT_REGION} --profile dev
